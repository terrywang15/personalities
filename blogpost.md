...
I made an autoencoder to measure latent personality traits in a meaningful way using personality survey responses, because these measurements can accurately be decoded back into survey responses. I created a method to interpret each dimension in the latent personality layer of the autoencoder model and explored the implications of such method. 
